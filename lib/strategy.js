 ...
 * @property {string} [domain="https://beta.forgehub.com"]
 * @property {string} [authorizationURL="https://beta.forgehub.com/oauth2/authorize"]
 * @property {string} [tokenURL="https://beta.forgehub.com/oauth2/token"]
...
function Strategy(options, verify) {
    options = options || {};
    domain = options.domain || 'https://beta.forgehub.com';
