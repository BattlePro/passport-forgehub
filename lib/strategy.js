 ...
 * @property {string} [domain="https://www.forgehub.com"]
 * @property {string} [authorizationURL="https://www.forgehub.com/oauth2/authorize"]
 * @property {string} [tokenURL="https://www.forgehub.com/oauth2/token"]
...
function Strategy(options, verify) {
    options = options || {};
    domain = options.domain || 'https://www.forgehub.com';
